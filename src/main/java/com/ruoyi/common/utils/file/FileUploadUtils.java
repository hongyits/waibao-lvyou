...
public class FileUploadUtils {
    ...
    public static final String uploadPdf(String baseDir, MultipartFile file, String[] allowedExtension)
            throws FileSizeLimitExceededException, IOException, FileNameLengthLimitExceededException,
            InvalidExtensionException {
        int fileNamelength = file.getOriginalFilename().length();
        if (fileNamelength > FileUploadUtils.DEFAULT_FILE_NAME_LENGTH) {
        ...
        File desc = getAbsoluteFile(baseDir, fileName);
        file.transferTo(desc);
        String pathFileName = getPathFileNamePdf(baseDir, fileName);
        return pathFileName;
    }
...
//        fileName = DateUtils.datePath() + "/" + IdUtils.fastUUID() + "." + fileName;
    ...
    private static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        ...
        String pathFileName = Constants.RESOURCE_PREFIX + "/" + currentDir + "/" + fileName; //todo
        return pathFileName;
    }

    private static final String getPathFileNamePdf(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = RuoYiConfig.getProfile().length() + 1;
        String currentDir = StringUtils.substring(uploadDir, dirLastIndex);
